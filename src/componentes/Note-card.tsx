...
export function NoteCard({note, onNoteDelete}: NoteCardprops){
    return(
        <Dialog.Root>
          <Dialog.Trigger className="rounded-md text-left outline-none flex flex-col bg-slate-700 p-5 gap-3 overflow-hidden relative hover:ring-2 hover:ring-slate-600 focus-visible:ring-2 focus-visible:ring-lime-400">
